...
from utils.model.fast_attention import fast_attention
...
def load_model(model_path, weights_path):
    ...
    :return:
    """
    model = seismo_transformer(maxlen = 400,
                               patch_size = 25,
                               num_channels = 3,
                               d_model = 48,
                               num_heads = 8,
...
def load_favor_model(model_path, weights_path):
    """
    Loads model and weights.
    :param model_path:
    :param weights_path:
    :return:
    """
    model = seismo_performer_with_spec(
        maxlen=400,
        nfft=128,
        patch_size_1=9,
        patch_size_2=5,
